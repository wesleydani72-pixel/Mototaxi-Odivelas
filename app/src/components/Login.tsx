...
export function Login() {
  ...
  const handleAtualizarSenhaDireto = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se for administrador jl6568402@gmail.com e não existir ainda localmente, criamos na hora (como o login faz)
      if (!foundUser && activeTab === 'admin' && idLimpo.toLowerCase() === 'jl6568402@gmail.com') {
